...
export const blocks: Block[] = [
    {
        ...
        text: (
            <>
                ...
                правда?)</span>.Учился на сисадмина, потом пытался поступить на финансы в Прагу, но судьба нас разлучила. Работал с криптой,
    ...
    },
    {
        ...
        text: (
            <>
                ...
                <span style={{ color: "rgba(255, 255, 255, 0.35)" }}>(интересно познавать себя).</span> <br />
